                    ...
                    <form action="{{route('ebooks.store')}}" method="POST" id="form-ebook" enctype="multipart/form-data">
                        ...
                        <div class="row mg-b-25">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="amount" name="amount" value="" placeholder="Enter price">
                                <small class="text-danger" id="err_price"></small>
                                <input class="form-control" type="hidden" id="price" name="price" value="" placeholder="Enter price">
                            </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-8">
                            <div class="form-group mg-b-10-force">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mg-b-10-force">
                                    <div class="image-preview-container">
                                        <img id="imagePreview" src="#" alt="Image Preview" style="display: none; max-width: 300; max-height: 300;"/>
                                    </div>
                                </div>
                            </div>
...
@push('scripts')
    ...
    <script>
        ...
        $('#amount').on('input', function(e)  {
            ...
            let amountValue = this.value.replace(/[^0-9]/g, '');
