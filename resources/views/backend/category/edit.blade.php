        ...
        <div class="row row-sm mg-t-20">
            <div class="col-lg-6">
                <div class="section-wrapper">
                    ...
                    <form action="{{route('categories.update',$category->id)}}" method="POST" id="form-category">
                        @csrf
                        <div class="form-layout form-layout-4">
                            <div class="row">
                                <label class="col-sm-4 form-control-label">Name <span class="tx-danger">*</span></label>
                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter Name Category" value="{{$category->name}}">
