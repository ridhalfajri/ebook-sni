<div class="container-fluid">
    <div class="slim-header-left">
        <h2 class="slim-logo"><a href="{{route('dashboard.index')}}">slim<span>.</span></a></h2>
        ...
        <div class="dropdown dropdown-c">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <nav class="nav">
                    ...
                    <a href="javascript:void(0)" onclick="logout()" class="nav-link"><i class="icon ion-forward"></i>Log Out</a>
                </nav>
            </div><!-- dropdown-menu -->
        </div><!-- dropdown -->
    </div><!-- header-right -->
